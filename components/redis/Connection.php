...
/**
 * Копипаста yii\redis\Connection с фиксом таймаута коннекта к Redis.
 * Просто расширить исходный класс не получается, потому что у них там private $_socket
 * Pull request отправлен команде yii2: https://github.com/yiisoft/yii2/issues/5876
 *
 * @see releaseSocket()
 * @see executeCommand()
 */
